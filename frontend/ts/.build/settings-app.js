...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var categoryContainerBackground = document.createElement('img');
    ...
    var regionsContainer = createSettingsContainer('language-region');
    var regionsSetting1 = createSetting('Region', regionsContainer);
    var regionsSetting2 = createSetting('Language', regionsContainer);
    var regionsSetting3 = createSetting('Time Zone', regionsContainer);
    ...
    var LanguageRegion = createCategory('Language & Region', './img/Settings_app/regions-language.png', regionsContainer);
