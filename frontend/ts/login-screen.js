...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let profiles = document.getElementsByClassName("login-screen-right-profile-box");
    ...
    let form = document.getElementsByClassName("login-screen-formulary")[0];
...
}
{
    ...
    let signUpConfirmPassword = document.getElementById("sign-up-confirm-password");
    let signUpPassword = document.getElementById("sign-up-password");
    if (signUpButton) {
        signUpButton.addEventListener("click", (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (signInButton) {
        signInButton.addEventListener("click", (event) => __awaiter(void 0, void 0, void 0, function* () {
            event.preventDefault();
