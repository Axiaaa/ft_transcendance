...
async function matchsRoutes(server) {
    ...
    server.route({
        ...
        handler: async (request, reply) => {
            ...
            const u1 = await (0, user_1.getUserFromDb)({ token: player1 });
            const u2 = await (0, user_1.getUserFromDb)({ token: player2 });
            if (u1 == null || u2 == null) {
    ...
    server.route({
        ...
        handler: async (request, reply) => {
            ...
            if (player1 != null && await (0, user_1.getUserFromDb)({ token: player1 }) == null ||
                player2 != null && await (0, user_1.getUserFromDb)({ token: player2 }) == null ||
                winner != null && await (0, user_1.getUserFromDb)({ token: winner }) == null) {
